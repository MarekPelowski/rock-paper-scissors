...
player_frame = Frame(root, bg="#5188b5", height=400, width=200)
player_frame.place(x=25, y=100)

enemy_frame = Frame(root, bg="#5188b5", height=400, width=200)
enemy_frame.place(x=525, y=100)

text_frame = Frame(root, bg="#3f6a99", height=60, width=760)
